// Technical sizing only. This background is original imagegen artwork.
...
const reference = path.join(root, 'references/world/home');
const source = path.join(reference, 'home-source.png');
const destination = path.join(root, 'public/assets/world/home.png');
...
console.log(`home: ${image.width}x${image.height} -> ${width}x${height}`);
