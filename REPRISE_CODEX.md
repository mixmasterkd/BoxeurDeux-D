...
Carnet de carrière dans le menu SNES et technique J–J–K débloquée par trois séquences réussies dans une leçon d’Octopus. Le J–K–J existant reste disponible. Mêmes contrôles E/WASD/J/K/P–Échap, joypad/A/B mobile hors action, mêmes proportions, sauvegardes et acquis conservés. Plafonds sportifs conservés pour que l’ordre libre reste viable. Migration v4, séjour et retours persistants, zéro paiement doublé. Agents séparés : carrière/carnet, Cuba/décors, combat/Dyrex/Louisto; racine Le Feu, liaisons, ateliers, intégration et vérifications. Le lot précédent ci-dessous est terminé et préservé.
...
La demande autorise intégration, commits intermédiaires et publication GitHub Pages selon le relais existant. Les achats futurs d’ordinateur/cellulaire et les achats en ligne restent une idée ultérieure, pas ce GO. Les sections « attendre GO » ci-dessous décrivent les livraisons précédentes. Chapitre intégré et vérifié localement : `a07883b` (économie/sauvegarde v3), `2164799` (runtime, visuels et tests). 285 tests autonomes, combats réellement joués, livraisons/boutiques/tenues, hôtel/journées et deux parcours de production passent. Le menu mobile est corrigé, y compris son défilement tactile. Chapitre publié avec `fa71f00`, workflow `34725796964` réussi. Les19 contrôles et233 ressources du vrai site public passent sans erreur; bundle identique à la compilation locale. Les dernières écritures ne changent que les preuves/captures. Lire `docs/VERIFICATIONS.md` pour le détail. Les références historiques ci-dessous restent conservées, sans limiter cette livraison.
