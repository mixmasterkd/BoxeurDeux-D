...
export class OpponentHUD {
  constructor(ui) {
    ...
    this.advice.innerHTML = '<strong>RÉMI DANS VOTRE COIN</strong><p></p>';
    ...
    this.figure.innerHTML = '<img alt="Votre boxeur assis sur un tabouret écoute Rémi, son coach, une serviette sur l’épaule." width="800" height="650"><figcaption>On reprend son souffle. On prépare la suite.</figcaption>';
