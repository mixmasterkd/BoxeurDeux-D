...
export const OPPONENT_PROFILES = Object.freeze({
  ...
  dyrex: Object.freeze({
    id: 'dyrex', name: 'Dyrex', shortName: 'Dyrex', official: true, maxResistance: 116,
    ...
    rhythm: Object.freeze({ initialOpening: 1.2, afterRecovery: 1.9 }),
    pattern: Object.freeze([
      { action: 'guard', duration: .65, guardLevel: 'head' },
      ...
      { attack: 'cross', target: 'head', tell: .70, opening: 1.9 },
      { action: 'guard', duration: .65, guardLevel: 'head' },
      { attack: 'cross', target: 'body', tell: .76, opening: 2.0 },
    ].map(Object.freeze)),
  }),
  lefeu: Object.freeze({
    id: 'lefeu', name: 'Le Feu', shortName: 'Le Feu', official: true, maxResistance: 126,
    ...
    rhythm: Object.freeze({ initialOpening: 1.15, afterRecovery: 1.9 }),
    pattern: Object.freeze([
      { action: 'guard', duration: .65, guardLevel: 'head' },
      { attack: 'cross', target: 'body', tell: .72, opening: .32 },
      { attack: 'jab', target: 'head', tell: .60, opening: 1.85 },
      { action: 'guard', duration: .75, guardLevel: 'head' },
      { attack: 'cross', target: 'body', tell: .68, opening: .28 },
      { attack: 'jab', target: 'head', tell: .56, opening: .28 },
      { attack: 'cross', target: 'head', tell: .60, opening: 2.05 },
    ].map(Object.freeze)),
  }),
  louisto: Object.freeze({
    id: 'louisto', name: 'Louisto', shortName: 'Louisto', official: true, region: 'cuba', maxResistance: 118,
    ...
    rhythm: Object.freeze({ initialOpening: 1.1, afterRecovery: 1.85 }),
    pattern: Object.freeze([
