...
export const DISTRICT_PLACES = ['residential', 'commercial', 'clothing-shop', 'boxing-shop'];
const scale = 1.5;
...
export const DISTRICT_LAYOUTS = {
  residential: {...outdoor,spawn:{x:2265,y:680,facing:'left'},obstacles:[
    ...
    r('depot',638,527,310,280),r('maisons-sud',1063,524,485,348),
    ...
    s('depot','Dépôt · Livraisons à vélo',795,825,80),s('maison-12','Livraison · 12',294,319),s('maison-24','Livraison · 24',793,319),s('maison-36','Livraison · 36',1295,319),
  ...
  commercial: {...outdoor,spawn:{x:2265,y:780,facing:'left'},obstacles:[
    ...
    s('closed-cafe','Café · Bientôt',250,280),s('closed-shop','Local · Bientôt',1380,280),s('works-commercial','Extension · Travaux',799,703,65)],
  },
};
...
export class DistrictWorld extends GymWorld {
  constructor({place,position}={}){const layout={...DISTRICT_LAYOUTS[place]};super({layout});this.place=place;
